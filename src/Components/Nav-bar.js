    ...
    return (
        <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
            ...
            <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8'}>
                ...
                <li className='border-b-2 border-zinc-300 w-full'><Link onClick={handleClose} to="/contact" smooth={true} offset={-50} duration={500}>Support</Link></li>
                <li className='border-b-2 border-zinc-300 w-full'><Link onClick={handleClose} to="/courses" smooth={true} offset={-100} duration={500}>Platforms</Link></li>
